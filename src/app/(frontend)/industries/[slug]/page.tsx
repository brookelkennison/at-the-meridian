...
//   if (!industry) return {}
//   return {
//     title: `${industry.name} — At The Meridian`,
//     description: industry.hero.sub,
//   }
// }
//
...
//           >
//             <span>←</span> Back to At The Meridian
//           </Link>
//           <span className="eyebrow-dark">{industry.hero.eyebrow}</span>
//           <h1 className="font-serif font-light tracking-tight leading-[0.98] text-[44px] sm:text-7xl lg:text-9xl mt-7 mb-8 max-w-[14ch]">
//             {industry.hero.h1Pre}{' '}
//             <em className="hero-italic-grad font-light">
//               {industry.hero.h1Italic}
//             </em>
//           </h1>
//           <p className="text-ink-dim text-base sm:text-lg max-w-[56ch] mb-12 leading-relaxed">
//             {industry.hero.sub}
//           </p>
...
//                 You're just stuck in the same trap.
//               </em>
//             </h2>
//           </Reveal>
...
//                 key={pain.title}
//                 delay={i * 60}
//                 className="p-7 lg:p-8 border border-line rounded bg-bg-3 hover:border-accent/30 transition-all"
//               >
...
//               <em className="italic text-accent">that compounds.</em>
//             </h2>
//           </Reveal>
//           <div className="grid grid-cols-2 lg:grid-cols-4 border-t border-line">
//             {industry.outcomes.map((o, i, arr) => (
//               <Reveal
//                 key={o.label}
//                 delay={i * 60}
